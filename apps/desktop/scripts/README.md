...
让应用无需用户预装 Python / Docker 即可跑 pr-agent（见 [docs/arch/02-agent/03-pragent-runtime](../../../docs/arch/02-agent/03-pragent-runtime.md)）。
...
│       └── meebox_pragent_shim/     # monkeypatch shim 包（无侵入补丁，见 docs/arch/02-agent/03-pragent-runtime.md）
